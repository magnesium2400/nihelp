...
% volume2adjacency
V = xyz2vol(ballMesh(r)+r+1, [], 0);
out = volume2adjacency(V, neighbors);
...
v = ballMesh(r);
V = xyz2vol(v+r+1, [], 0);
a = volume2adjacency(V, neighbors);
[s,t] = find(a);
...
v = ballMesh(r);
V = xyz2vol(v+r+1, [], 0);
a1 = volume2adjacency(V, 6);
a2 = volume2adjacency(V, 18);
a3 = volume2adjacency(V, 26);
[s1,t1] = find(a1);
[s2,t2] = find(a2&~a1);
[s3,t3] = find(a3&~a2);
